...
import useUpdateDiscount from 'features/admin/discount/hooks/useUpdateDiscount'
...
interface IUpdateDiscountModal {
  open: boolean
  setOpen: (value: boolean) => void
  id: string
}

function UpdateDiscountModal({ open, setOpen, id }: IUpdateDiscountModal) {
  const { onSubmit, control, isPending, isValid, watch } = useUpdateDiscount({
    onSuccess: () => {
      setOpen(false)
    },
    id: id
